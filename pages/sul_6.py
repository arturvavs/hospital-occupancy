...
dash.register_page(__name__, path='/6sul')
...
layout = html.Div(children=[
    html.Div([
        ...
        html.H2('6º SUL', className='subtitulo')
    ], className='cabecalho'),
    ...
    html.Div([
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-6sul', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-pacientes-6sul', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-livres-6sul', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-higienizacao-6sul', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-reservados-6sul', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
...
#ARMAZENAMENTO DE INFORMAÇÃO SOBRE PAGINA DA TABELA
        dcc.Store(id='page-store-6sul', data={'current_page': 0}),
        dcc.Store(id='dataset-6sul'),
...
@callback(
    Output('total-leitos-6sul', 'children'),
    Output('total-pacientes-6sul', 'children'),
    Output('total-leitos-livres-6sul', 'children'),
    Output('total-leitos-higienizacao-6sul', 'children'),
    Output('total-leitos-reservados-6sul', 'children'),
    Output('dataset-6sul','data'),
    Input('interval-component-6sul','n_intervals')
)
def update_cards(n_intervals):
    df_pacientes = database.get_data(sql)
    filter_df_pacientes = df_pacientes[df_pacientes['SETOR_REDUZIDO'] == '6º SUL']
...
@callback(
    Output('table-data-6sul', 'data'), #Callback para atualizar a tabela
    Output('table-data-6sul', 'page_current'), #Callback para atualizar a página da tabela
    Input('interval-component-6sul', 'n_intervals'), #Callback que obtem do dcc.Interval o valor n_intervals para atualização da página
    Input('dataset-6sul','data'),
    State('page-store-6sul', 'data') #Callback para identificar qual a página atual da tabela
)
...
@callback(
    Output('page-store-6sul', 'data'),
    Input('interval-component-6sul', 'n_intervals'),
    State('page-store-6sul', 'data')
)

...
dash.register_page(__name__, path='/3oeste')
...
layout = html.Div(children=[
    html.Div([
        ...
        html.H2('3º OESTE', className='subtitulo')
    ], className='cabecalho'),
    ...
    html.Div([
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-3oeste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-pacientes-3oeste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-livres-3oeste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-higienizacao-3oeste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-reservados-3oeste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
...
#ARMAZENAMENTO DE INFORMAÇÃO SOBRE PAGINA DA TABELA
        dcc.Store(id='page-store-3oeste', data={'current_page': 0}),
        dcc.Store(id='dataset-3oeste'),
    
    html.Div([
        dcc.Link(href='/3oeste')
    ], className='link')
],id='layout_p4')

# Callback para atualizar os valores dos cartões
@callback(
    Output('total-leitos-3oeste', 'children'),
    Output('total-pacientes-3oeste', 'children'),
    Output('total-leitos-livres-3oeste', 'children'),
    Output('total-leitos-higienizacao-3oeste', 'children'),
    Output('total-leitos-reservados-3oeste', 'children'),
    Output('dataset-3oeste','data'),
    Input('interval-component-3oeste','n_intervals')
)
def update_cards(n_intervals):
    df_pacientes = database.get_data(sql)
    filter_df_pacientes = df_pacientes[df_pacientes['SETOR_REDUZIDO'] == '3º OESTE']
...
@callback(
    Output('table-data-3oeste', 'data'), #Callback para atualizar a tabela
    Output('table-data-3oeste', 'page_current'), #Callback para atualizar a página da tabela
    Input('interval-component-3oeste', 'n_intervals'), #Callback que obtem do dcc.Interval o valor n_intervals para atualização da página
    Input('dataset-3oeste','data'),
    State('page-store-3oeste', 'data') #Callback para identificar qual a página atual da tabela
)
...
@callback(
    Output('page-store-3oeste', 'data'),
    Input('interval-component-3oeste', 'n_intervals'),
    State('page-store-3oeste', 'data')
)

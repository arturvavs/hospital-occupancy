...
dash.register_page(__name__, path='/2leste')
...
layout = html.Div(children=[
    html.Div([
        ...
        html.H2('2º LESTE', className='subtitulo')
    ], className='cabecalho'),
    ...
    html.Div([
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-2leste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-pacientes-2leste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-livres-2leste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-higienizacao-2leste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Div(id='total-leitos-reservados-2leste', className='text-center', style={"font-size": "50px", "font-family": "Trebuchet MS", "line-height": "2.0"})
            ])
...
#ARMAZENAMENTO DE INFORMAÇÃO SOBRE PAGINA DA TABELA
        dcc.Store(id='page-store-2leste', data={'current_page': 0}),
        dcc.Store(id='dataset-2leste'),
    
    html.Div([
        dcc.Link(href='/2leste')
    ], className='link')
],id='layout_p2')

# Callback para atualizar os valores dos cartões
@callback(
    Output('total-leitos-2leste', 'children'),
    Output('total-pacientes-2leste', 'children'),
    Output('total-leitos-livres-2leste', 'children'),
    Output('total-leitos-higienizacao-2leste', 'children'),
    Output('total-leitos-reservados-2leste', 'children'),
    Output('dataset-2leste','data'),
    Input('interval-component-2leste','n_intervals')
)
...
@callback(
    Output('table-data-2leste', 'data'), #Callback para atualizar a tabela
    Output('table-data-2leste', 'page_current'), #Callback para atualizar a página da tabela
    Input('interval-component-2leste', 'n_intervals'), #Callback que obtem do dcc.Interval o valor n_intervals para atualização da página
    Input('dataset-2leste','data'),
    State('page-store-2leste', 'data') #Callback para identificar qual a página atual da tabela
)
...
@callback(
    Output('page-store-2leste', 'data'),
    Input('interval-component-2leste', 'n_intervals'),
    State('page-store-2leste', 'data')
)
